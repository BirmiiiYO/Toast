...
var scale = We(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["\n 0% { transform: scale(0) }\n 100% {transform: scale(1) }\n"], ["\n 0% { transform: scale(0) }\n 100% {transform: scale(1) }\n"])));
var move = We(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n 0% { right: -120%; }\n 100% { right: 0%; }\n"], ["\n 0% { right: -120%; }\n 100% { right: 0%; }\n"])));
...
var ToastInfo = qe.div(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject([""], [""])));
var ToastContainer$1 = qe.div(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\nalign-items: center;\nanimation-duration: 0.5s;\nanimation-name: ", ";\nbackground-color: ", ";\nborder-radius: 5px;\nbox-sizing: border-box;\ncolor: white;\ndisplay:flex;\njustify-content: start;\nmax-width: 300px;\nmin-height: 100px;\nposition:relative;\n"], ["\nalign-items: center;\nanimation-duration: 0.5s;\nanimation-name: ", ";\nbackground-color: ", ";\nborder-radius: 5px;\nbox-sizing: border-box;\ncolor: white;\ndisplay:flex;\njustify-content: start;\nmax-width: 300px;\nmin-height: 100px;\nposition:relative;\n"])), function (_a) {
...
var ToastIcon = qe.img(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  height: 30px;\n  padding: 0 20px;\n  width: 30px;\n"], ["\n  height: 30px;\n  padding: 0 20px;\n  width: 30px;\n"])));
var ToastClose = qe.img(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  cursor: pointer;\n  height: 20px;\n  position: absolute;\n  right: 10px;\n  top: 10px;\n  width: 20px;\n"], ["\n  cursor: pointer;\n  height: 20px;\n  position: absolute;\n  right: 10px;\n  top: 10px;\n  width: 20px;\n"])));
var ToastTitle = qe.h1(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  font-size: 24px;\n  margin: 0px;\n  overflow: hidden;\n  width: 200px;\n"], ["\n  font-size: 24px;\n  margin: 0px;\n  overflow: hidden;\n  width: 200px;\n"])));
var ToastDescription = qe.span(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  font-size: 18px;\n  max-width: 200px;\n"], ["\n  font-size: 18px;\n  max-width: 200px;\n"])));
...
var useToast = function () {
    var _a = r.useState(false), loaded = _a[0], setLoaded = _a[1];
    var portalId = r.useState("".concat(v4()))[0];
...
var Toast = /** @class */ (function () {
    function Toast() {
        ...
        this.generateToast = function (toastOptions) { return (__assign({ id: v4() }, toastOptions)); };
...
var setPosition = function (position) {
    switch (position) {
        case ToastPosition.TOP_LEFT:
            return Ae(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["\n        left: 10px;\n        top: 10px;\n      "], ["\n        left: 10px;\n        top: 10px;\n      "])));
        case ToastPosition.TOP_RIGHT:
            return Ae(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n        right: 10px;\n        top: 10px;\n      "], ["\n        right: 10px;\n        top: 10px;\n      "])));
        case ToastPosition.BOTTOM_LEFT:
            return Ae(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n        bottom: 10px;\n        left: 10px;\n      "], ["\n        bottom: 10px;\n        left: 10px;\n      "])));
        default:
            return Ae(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n        bottom: 10px;\n        right: 10px;\n      "], ["\n        bottom: 10px;\n        right: 10px;\n      "])));
    }
};
var templateObject_1$1, templateObject_2, templateObject_3, templateObject_4;

var ToastContainer = qe.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n  margin: ", "px;\n  position: fixed;\n  ", "\n"], ["\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n  margin: ", "px;\n  position: fixed;\n  ", "\n"])), function (_a) {
...
var ToastPortal = r.forwardRef(function (_a, ref) {
    ...
    var toasts = toastService.toasts, removeToast = toastService.removeToast, getAllToasts = toastService.getAllToasts, generateToast = toastService.generateToast, addToast = toastService.addToast;
    var _f = useToast(), loaded = _f.loaded, portalId = _f.portalId;
    var _g = r.useState(''), removingId = _g[0], setRemovingId = _g[1];
    var _h = r.useState(getAllToasts().length), toastsLength = _h[0], setToastsLength = _h[1];
    r.useEffect(function () {
    ...
    r.useImperativeHandle(ref, function () { return ({
        addMessage: function (toast) {
            var newToast = generateToast(toast);
            addToast(newToast);
            setToastsLength(toasts.length);
        },
    }); });
    ...
    return loaded
        ? ReactDOM__default["default"].createPortal(jsxRuntime.jsx(ToastContainer, __assign({ position: position, autoClose: autoClose, autoCloseTime: autoCloseTime, margin: margin }, { children: toasts
                .map(function (_a) {
...
var useToastRef = function () {
    var toastRef = r.useRef(null);
...
exports.useToastRef = useToastRef;
