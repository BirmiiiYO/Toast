...
import r, { useRef, useDebugValue, useContext, createElement, useState, useEffect, forwardRef, useImperativeHandle } from 'react';
...
var Toast$1 = function (_a) {
    ...
    return (jsxs(ToastContainer$1, __assign({ mode: mode, backgroundColor: backgroundColor, animationType: animationType }, { children: [jsx(ToastIcon, { src: getImage(mode) }), jsxs(ToastInfo, { children: [jsx(ToastTitle, { children: title }), jsx(ToastDescription, { children: description })] }), jsx(ToastClose, { onClick: onToastClose, src: iconClose, alt: "close notification" })] })));
};
...
var ToastPortal = forwardRef(function (_a, ref) {
    ...
    return loaded
        ? ReactDOM.createPortal(jsx(ToastContainer, __assign({ position: position, autoClose: autoClose, autoCloseTime: autoCloseTime, margin: margin }, { children: toasts
                .map(function (_a) {
