...
var ToastBlock$1 = qe.div(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\nalign-items: center;\nanimation-duration: 0.5s;\nanimation-name: ", ";\nbackground-color: ", ";\nborder-radius: 5px;\nbox-sizing: border-box;\ncolor: white;\ndisplay:flex;\njustify-content: start;\nmax-width: 300px;\nmin-height: 100px;\nposition:relative;\n"], ["\nalign-items: center;\nanimation-duration: 0.5s;\nanimation-name: ", ";\nbackground-color: ", ";\nborder-radius: 5px;\nbox-sizing: border-box;\ncolor: white;\ndisplay:flex;\njustify-content: start;\nmax-width: 300px;\nmin-height: 100px;\nposition:relative;\n"])), function (_a) {
...
var Toast$1 = function (_a) {
    ...
    return (jsxs(ToastBlock$1, __assign({ mode: mode, backgroundColor: backgroundColor, animationType: animationType }, { children: [jsx(ToastIcon, { src: getImage(mode) }), jsxs(ToastInfo, { children: [jsx(ToastTitle, { children: title }), jsx(ToastDescription, { children: description })] }), jsx(ToastClose, { onClick: onToastClose, src: iconClose, alt: "close notification" })] })));
};
...
var ToastBlock = qe.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n  margin: ", "px;\n  position: fixed;\n  ", "\n"], ["\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n  margin: ", "px;\n  position: fixed;\n  ", "\n"])), function (_a) {
